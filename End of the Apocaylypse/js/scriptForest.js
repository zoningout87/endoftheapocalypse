...
let background = document.getElementById("backgroundForest");
let laag4 = document.getElementById("laag4Forest");
let laag3 = document.getElementById("laag3Forest");
let laag2 = document.getElementById("laag2Forest");
let bovenstelaag = document.getElementById("bovenstelaagForest");
let forestBladerdek = document.getElementById("bladerdekForest");


window.addEventListener('scroll', function(){
    var value = this.window.scrollX;
    background.style.left = -value * 0.40 + 'px';
    laag4.style.left = value * 0.35 + 'px';
    laag3.style.left = value * 0.25 + 'px';
    laag2.style.left = value * 0.15 + 'px';
    bovenstelaag.style.left = -value * 0.10 + 'px';
    forestBladerdek.style.left = -value * 0.02 + 'px';
